...
*Dernière mise à jour: 12/01/2026 20:28:45*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 650ms | 71.17% | 74.22% | 78.15% |
| **Website** | ✅ Opérationnel | 240ms | 97.3% | 99.64% | 99.76% |
...
- **API** - ❌ Hors service depuis 5h 27m
- **API** - ⚠️ Dégradé depuis 7h 5m
