...
*Dernière mise à jour: 29/01/2026 22:57:26*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 685ms | 62.32% | 71.03% | 74.57% |
| **Website** | ✅ Opérationnel | 200ms | 100% | 99.58% | 99.77% |
...
- **API** - ❌ Hors service depuis 4h 31m
