...
*Dernière mise à jour: 31/01/2026 11:23:39*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ⚠️ Dégradé | 7641ms | 54.55% | 66.62% | 73.84% |
| **Website** | ✅ Opérationnel | 348ms | 100% | 99.54% | 99.79% |
...
- **API** - ❌ Hors service depuis 3h 7m
- **API** - ❌ Hors service depuis 15h 19m
- **API** - ⚠️ Dégradé depuis 15h 40m
- **API** - ❌ Hors service depuis 16h 2m
- **API** - ❌ Hors service depuis 18h 0m
