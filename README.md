...
*Dernière mise à jour: 01/02/2026 12:50:52*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 615ms | 67.03% | 63.89% | 73.4% |
| **Website** | ✅ Opérationnel | 287ms | 100% | 99.51% | 99.79% |
...
- **API** - ❌ Hors service depuis 17h 28m
