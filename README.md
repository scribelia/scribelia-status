...
*Dernière mise à jour: 04/02/2026 18:24:32*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ⚠️ Dégradé | 7958ms | 58.33% | 59.14% | 71.29% |
| **Website** | ✅ Opérationnel | 196ms | 100% | 100% | 99.77% |
...
- **API** - ⚠️ Dégradé depuis 1h 39m
- **API** - ❌ Hors service depuis 19h 5m
