...
*Dernière mise à jour: 01/02/2026 10:38:38*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 900ms | 67.39% | 64.4% | 73.44% |
| **Website** | ✅ Opérationnel | 223ms | 100% | 99.51% | 99.79% |
...
- **API** - ⚠️ Dégradé depuis 21h 18m
- **API** - ⚠️ Dégradé depuis 23h 15m
