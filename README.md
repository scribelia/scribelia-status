...
*Dernière mise à jour: 30/12/2025 23:59:43*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 747ms | 78.23% | 82.68% | 82.68% |
| **Website** | ✅ Opérationnel | 913ms | 100% | 99.8% | 99.8% |
...
- **Temps de réponse moyen (7j):** 789ms
