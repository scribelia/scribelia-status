...
*Dernière mise à jour: 04/02/2026 07:48:08*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 911ms | 50.85% | 59.16% | 71.47% |
| **Website** | ✅ Opérationnel | 764ms | 100% | 100% | 99.77% |
...
- **API** - ❌ Hors service depuis 8h 28m
- **API** - ⚠️ Dégradé depuis 15h 10m
