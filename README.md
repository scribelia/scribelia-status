...
*Dernière mise à jour: 30/01/2026 23:56:04*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 567ms | 51.43% | 67.41% | 73.9% |
| **Website** | ✅ Opérationnel | 236ms | 100% | 99.55% | 99.79% |
...
- **API** - ❌ Hors service depuis 4h 34m
- **API** - ❌ Hors service depuis 6h 33m
