...
*Dernière mise à jour: 04/02/2026 23:13:07*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 681ms | 59.02% | 59.01% | 71% |
| **Website** | ✅ Opérationnel | 1008ms | 100% | 100% | 99.77% |
...
- **API** - ⚠️ Dégradé depuis 2h 42m
- **API** - ❌ Hors service depuis 23h 53m
