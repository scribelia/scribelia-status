...
*Dernière mise à jour: 13/01/2026 09:59:37*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ⚠️ Dégradé | 8155ms | 67.86% | 74.28% | 78% |
| **Website** | ✅ Opérationnel | 232ms | 100% | 99.64% | 99.77% |
...
- **API** - ❌ Hors service depuis 18h 58m
- **API** - ⚠️ Dégradé depuis 20h 36m
