...
*Dernière mise à jour: 29/01/2026 22:37:49*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ❌ Hors service | 10004ms | 62.32% | 71.17% | 74.61% |
| **Website** | ✅ Opérationnel | 388ms | 100% | 99.58% | 99.77% |
...
- **API** - ❌ Hors service depuis 4h 11m
- **API** - ❌ Hors service depuis 5h 16m
