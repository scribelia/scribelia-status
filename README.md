...
*Dernière mise à jour: 12/01/2026 20:40:39*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 712ms | 70.64% | 74.19% | 78.16% |
| **Website** | ✅ Opérationnel | 450ms | 97.25% | 99.64% | 99.76% |
...
- **API** - ❌ Hors service depuis 5h 39m
- **API** - ⚠️ Dégradé depuis 7h 17m
