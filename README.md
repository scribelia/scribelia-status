...
*Dernière mise à jour: 12/01/2026 21:55:40*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 733ms | 69.44% | 74.07% | 78.16% |
| **Website** | ✅ Opérationnel | 280ms | 97.22% | 99.64% | 99.76% |
...
- **API** - ❌ Hors service depuis 6h 54m
- **API** - ⚠️ Dégradé depuis 8h 32m
