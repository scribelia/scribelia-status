...
*Dernière mise à jour: 12/01/2026 16:44:33*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ⚠️ Dégradé | 8197ms | 73.28% | 74.43% | 78.19% |
| **Website** | ✅ Opérationnel | 249ms | 97.41% | 99.64% | 99.76% |
...
- **API** - ❌ Hors service depuis 1h 43m
- **API** - ⚠️ Dégradé depuis 3h 21m
