...
*Dernière mise à jour: 22/01/2026 06:21:21*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ⚠️ Dégradé | 6866ms | 60.24% | 74.84% | 76.91% |
| **Website** | ✅ Opérationnel | 380ms | 100% | 99.87% | 99.81% |
...
- **API** - ❌ Hors service depuis 14h 21m
- **API** - ⚠️ Dégradé depuis 14h 24m
