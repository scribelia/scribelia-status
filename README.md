...
*Dernière mise à jour: 01/02/2026 16:30:06*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 617ms | 66.3% | 63.59% | 73.33% |
| **Website** | ✅ Opérationnel | 405ms | 100% | 99.51% | 99.79% |
...
- **API** - ❌ Hors service depuis 21h 8m
