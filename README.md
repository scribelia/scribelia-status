...
*Dernière mise à jour: 30/01/2026 11:46:29*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ⚠️ Dégradé | 9002ms | 59.42% | 70.27% | 74.42% |
| **Website** | ✅ Opérationnel | 375ms | 100% | 99.57% | 99.76% |
...
- **API** - ❌ Hors service depuis 17h 20m
- **API** - ❌ Hors service depuis 18h 25m
