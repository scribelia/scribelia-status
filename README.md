...
*Dernière mise à jour: 01/02/2026 16:58:04*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 745ms | 67.03% | 63.47% | 73.32% |
| **Website** | ✅ Opérationnel | 213ms | 100% | 99.5% | 99.79% |
...
- **API** - ❌ Hors service depuis 21h 36m
