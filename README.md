...
*Dernière mise à jour: 28/12/2025 09:44:48*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 731ms | 82.88% | 84.94% | 84.94% |
| **Website** | ✅ Opérationnel | 1835ms | 99.32% | 99.4% | 99.4% |
...
- **Temps de réponse moyen (7j):** 1127ms
